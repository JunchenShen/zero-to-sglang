...
const chSidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '第 2 章 一个请求的旅程（概念）', link: '/ch/part2/第2章_InsideSGLang' },
      { text: '第 2 章 一个请求的旅程（代码走读）', link: '/ch/part2/第2章_code部分_一个请求的旅程' },
...
const engSidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Chapter 2 Inside SGLang (Code Walkthrough)', link: '/eng/part2/Chapter2_Coding_Inside-SGLang' },
